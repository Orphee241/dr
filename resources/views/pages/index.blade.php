                        ...
                        <div class="col-auto">
                            <nav class="main-menu menu-style1 d-none d-lg-block">
                                <ul>
                                    ...
                                    <li class="menu-item-has-children">
                                        <a href="index.html"><span class="has-new-lable">Accueil</span></a>
                                    </li>
                                    <li>
                                        <a href="about.html">Activités</a>
                                    </li>
                                    <li class="menu-item-has-children">
                                        <a href="service.html">Mission</a>
                                    </li>
                                    ...
                                    <li class="menu-item-has-children mega-menu-wrap">
                                        <a href="#"><span class="has-new-lable">A propos de
                                                nous{{-- <span
            ...
            <div class="row justify-content-between">
                <div class="col-lg-auto text-center text-lg-start">
                    <div class="title-area">
                        ...
                        <h2 class="sec-title h1">Customer’s Feedback</h2>
                    </div>
                </div>
                ...
                <div class="col-xl-4">
                    <div class="testi-style1">
                        ...
                        <p class="testi-text">“Engineer resource maximizing whereas human high quality scenarios via
                            client incentivize next generatio”</p>
